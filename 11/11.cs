...
class Monkey
{
    ...
    {
        // Console.WriteLine("this shold now add item worry {0} to {1}, items: {2} ", itemWorry, MonkeyID, string.Join(";", Items));
        Items.Add(itemWorry);
              // Console.WriteLine("this shold have now added item worry {0} to {1}, items: {2} ", itemWorry, MonkeyID, string.Join(";", Items));
